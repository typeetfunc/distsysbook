...
В чем разница между утверждением и вычислением? Давайте расммотрим запрос "Эта пицца овощная?". Для ответа, мы должны вникнуть в суть: когда приемлимо сделать вывод что чтолибо верно(или не верно)?
